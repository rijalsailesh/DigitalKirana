            ...
            <div class="card-body bg-gray">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="businessName" id="businessName" class="form-control" placeholder="Business Name"  required>
                    </div>
                    <div class="col-md-6 mb-4">
                        <label for="businessEmail">Business Email</label>
                        <input type="email" name="businessEmail" id="businessEmail" class="form-control" placeholder="Business Email"  required>
                    </div>
                    <div class="col-md-6 mb-4">
                        <label for="businessPhone">Business Phone</label>
                        <input type="text" name="businessPhone" id="businessPhone" class="form-control" placeholder="Business Phone" required>
                    </div>
                    <div class="col-md-6 mb-4">
                        <label for="businessAddress">Business Address</label>
                        <input type="text" name="businessAddress" id="businessAddress" class="form-control" placeholder="Business Address" required>
                    </div>
                </div>
            </div>
